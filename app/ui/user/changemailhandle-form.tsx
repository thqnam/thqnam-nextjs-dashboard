...
import { changeMailHandle } from '@/app/lib/actions/functions/users';
import { ChangeMailHandleState } from '@/app/lib/actions/types/users';
...
export default function Form( {newemail, oldemail, name, image} : FormProps) {
