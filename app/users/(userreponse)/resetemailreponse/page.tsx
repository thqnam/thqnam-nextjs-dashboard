...
export const metadata: Metadata = {
  title: 'Reset Email Address Reponse',
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`${lusitana.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Reset Email Address Request successful !</strong>{' '}
            But you need to complete your Reset Email Address Request.{' '}
            Please check your email box to find your reset email address link.{' '}
            For verify your this Reset Email Address Request.{' '}
